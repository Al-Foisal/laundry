...
class PageController extends Controller {
    ...
    public function pageUpdate(Request $request, Page $page) {
        ...
        return redirect()->route('admin.pages.pageList')->withToastSuccess('Page updated successfully!!');
    }

    public function pageDelete(Request $request, Page $page) {
        $page->delete();

        return redirect()->route('admin.pages.pageList')->withToastSuccess('Page deleted successfully!!');
    }
    ...
    public function pageActive(Request $request, Page $page) {
        ...
        return redirect()->route('admin.pages.pageList')->withToastSuccess('Page activated successfully!!');
    }
    ...
    public function pageInactive(Request $request, Page $page) {
        ...
        return redirect()->route('admin.pages.pageList')->withToastSuccess('Page inactivated successfully!!');
    }
