            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <a href="{{ route('admin.pages.pageCreate') }}" class="btn btn-outline-primary">Add Page</a>
                            <br>
                            <br>
                            <table id="" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($pages as $page)
                                        <tr>
                                            <td>
                                                <a href="{{ route('admin.pages.pageEdit', $page) }}"
                                                    class="btn btn-info btn-xs"> <i class="fas fa-edit"></i> </a>
                                                @if ($page->status === 1)
                                                    <form action="{{ route('admin.pages.pageInactive', $page) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit"
                                                ...
                                                @else
                                                    <form action="{{ route('admin.pages.pageActive', $page) }}"
                                                        method="post">
                                                        @csrf
                                                        <button type="submit"
                                                ...
                                                @endif
                                                <form action="{{ route('admin.pages.pageDelete', $page) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="submit"
