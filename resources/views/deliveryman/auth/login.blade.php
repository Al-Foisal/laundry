...
<head>
    ...
    <title>Deliveryman Login Area - {{ config('app.name') }}</title>
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('deliveryman.auth.storeLogin') }}" method="post">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="icheck-primary">
                                <a href="{{ route('deliveryman.auth.forgotPassword') }}">
