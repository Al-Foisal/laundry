...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('backend/css/responsive.bootstrap4.min.css') }}">
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        @include('deliveryman.layouts.partials._navbar')
        <!-- /.navbar -->

        <!-- Main Sidebar Container -->
        @include('deliveryman.layouts.partials._sidebar')
        ...
        <!-- Control Sidebar -->
        @include('deliveryman.layouts.partials._control-sidebar')
        <!-- /.control-sidebar -->

        <!-- Main Footer -->
        @include('deliveryman.layouts.partials._footer')
    </div>
    <!-- ./wrapper -->
