...
<head>
    ...
    <title>Partner Login Area - {{ config('app.name') }}</title>
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('partner.auth.storeLogin') }}" method="post">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="icheck-primary">
                                <a href="{{ route('partner.auth.forgotPassword') }}">
                ...
                <p class="mb-1">
                    <a href="{{ route('partner.auth.createPartner') }}">Join with us.</a>
                </p>
            </div>
            <!-- /.card-body -->
        </div>
